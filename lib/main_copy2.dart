                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20.0), // Jarak antara form-login dan tombol
                      Row(
                        mainAxisAlignment: MainAxisAlignment.end,  // Mengatur posisi tombol ke kanan
                        children: [
                          ElevatedButton(
                            onPressed: () {
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor: Color(
                                  0xFF434A51), // Warna sesuai dengan yang diminta (434A51)
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                fontFamily: 'Poppins',
                                color: Colors.white,
                                fontSize: 16.0, // Ukuran teks sesuai kebutuhan
                              ),
                            ),
                          ),
                        ],
